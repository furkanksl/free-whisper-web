  ...
  const features = [
    {
      ...
      description:
        "Your audio never leaves your device. No cloud processing, no data collection.",
      color: "from-blue-500 to-cyan-600",
      bgColor:
        "bg-gradient-to-br from-blue-50/80 to-cyan-50/80 dark:from-blue-900/20 dark:to-cyan-900/20",
      borderColor: "border-blue-200/50 dark:border-cyan-800/30",
    },
    {
      icon: Cpu,
      title: "AI-Powered",
      description:
        "Advanced Whisper AI model running locally for unmatched accuracy.",
      color: "from-cyan-500 to-blue-600",
      bgColor:
        "bg-gradient-to-br from-cyan-50/80 to-blue-50/80 dark:from-cyan-900/20 dark:to-blue-900/20",
      borderColor: "border-cyan-200/50 dark:border-blue-800/30",
    },
    {
      icon: Zap,
      title: "Lightning Fast",
      description:
        "Real-time transcription with minimal latency and maximum performance.",
                    ...
                    >
                      ...
                      <div className="bg-slate-50/80 dark:bg-slate-800/80 rounded-lg p-4 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50">
                        <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                          Transform your voice into text with unmatched accuracy
                          and privacy.
                          <motion.span
                ...
                <div className="relative mt-44">
                  ...
                  >
                    ...
                    <p className="text-slate-600 dark:text-slate-300 max-w-xl mx-auto">
                      Experience the perfect blend of privacy, performance, and
                      precision
                    </p>
                  </motion.div>
